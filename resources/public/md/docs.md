<div class="bs-callout bs-callout-danger">
 ...
 <ol>
   ...
   <li> Update the connection parameters for the database in the <code>inventory.models.schema</code> namespace of your application.
...
Two middleware functions are provided by default in the `inventory.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `inventory.handler` namespace to manage the enabled middleware.
